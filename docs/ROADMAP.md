...
| 2 | Cast units to KSG's seeded Logic IR prototypes (T1–T6 in `KSG-LOGIC-IR-STATUS.md`), live KSG round-trip against a dev server, graph / inspector / history / diff UI (Vite + Cytoscape), evaluation summary UI, release-contract smoke in CI | next |
